    ...
    <Navbar className={`${s.root} d-print-none`}>
      <div>
        <NavLink
          ...
          className={`d-md-none me-3 ${s.navItem}`}
          href="#"
        >
      ...
      <Nav className="ms-auto">
        <NavItem className="d-sm-none me-4">
          <NavLink
            className=""
            href="#"
          >
        ...
        <Dropdown nav isOpen={menuOpen} toggle={() => toggleMenu()} className="tutorial-dropdown me-2 me-sm-3">
          <DropdownToggle nav>
        ...
        <Dropdown isOpen={notificationsOpen} toggle={() => toggleNotifications()} nav id="basic-nav-dropdown" className="ms-3">
          <DropdownToggle nav caret className="navbar-dropdown-toggle">
            <span className={`${s.avatar} rounded-circle float-left me-2`}>
              <img src={userImg} alt="User"/>
            </span>
            <span className="small d-none d-sm-block ms-1 me-2 body-1">admin user</span>
          </DropdownToggle>
          <DropdownMenu className="navbar-dropdown profile-dropdown" style={{ width: "194px" }}>
            ...
            <NavItem>
              <NavLink onClick={() => doLogout()} href="#">
                <button className="btn btn-primary rounded-pill mx-auto logout-btn" type="submit"><img src={logoutIcon} alt="Logout"/><span className="ms-1">Logout</span></button>
              </NavLink>
            </NavItem>
          </DropdownMenu>
        </Dropdown>
