                    ...
                    {firstTable
                      ...
                      .map(item => (
                        <tr key={uuidv4()}>
                          ...
                          <td className="d-flex align-items-center"><img className={s.image} src={item.img} alt="User"/><span className="ms-3">{item.name}</span></td>
                          <td>{item.company}</td>
                          <td>{item.city}</td>
                          <td>{item.state}</td>
                        </tr>
                ...
                <div className={s.widgetContentBlock}>
                  {transactions.map(item => (
                    <div key={uuidv4()} className={s.content}>
                      <div><img src={item.icon} alt="Item" /><span className="body-2 ms-3">{item.category}</span></div>
